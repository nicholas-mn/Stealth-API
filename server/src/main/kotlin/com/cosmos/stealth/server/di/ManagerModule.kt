...
object ManagerModule {
    ...
    val managerModule = module {
        single { provideGatewayManager(get(), get()) }
    }

    private fun provideGatewayManager(redditGateway: RedditGateway, tedditGateway: TedditGateway): GatewayManager {
        return GatewayManager(redditGateway, tedditGateway)
    }
}
